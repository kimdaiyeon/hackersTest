<form name="obj" method="post" action="">
	...
	*이전 개인정보취급방침 보기(2014년 2월 1일부터 시행된 방침) 
				...
				<div class="box-btn">
					<!-- <input type="submit" class="btn-1" value="다음단계 (휴대폰인증)"> -->
					<a href="#" class="btn-l" id="gopage2">다음단계 (휴대폰인증)</a>
				</div>
		...
		$("#gopage2").click(function(){
			...
			if(check1 == true & check2 == true){
				$.post("/member/membervar.php",{pageCheck:pageCheck},
					function(data){
						location.replace("/member/index.php?mode=step_02");
				});
			}else {
				alert("필수약관에 동의하지 않으셨습니다.");
			}
		})
	})	
</script>